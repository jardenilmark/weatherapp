...
export const landscapeStyles = StyleSheet.create({
  ...
  githubName: { textAlign: 'center', fontSize: getScreenHeight * 0.06, fontWeight: 'bold' },
  githubURL: { textAlign: 'center', color: 'blue', textDecorationLine: 'underline', fontSize: getScreenHeight * 0.04 },
  coordinatesView: { alignSelf: 'center', flex: 1 },
  coordinatesText: { textAlign: 'center', fontSize: getScreenHeight * 0.044 },
  buttonView: { width: getScreenHeight * 0.4, alignItems: 'center', alignSelf: 'center', paddingTop: 20 },
})
